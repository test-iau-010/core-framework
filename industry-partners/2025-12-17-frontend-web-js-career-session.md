...
## 📅 ۱. جزئیات جلسه
* **محور جلسه:** بررسی بازار کار طراحی وب با تمرکز بر Frontend و زبان JavaScript  
* **تاریخ:** ۱۷ دسامبر  
...
| پرزنت نقشه راه Frontend | نشست پایانی و تبادل نظر |
| :---: | :---: |
| ![Roadmap](media/.jpg) | ![Group Screenshot](media/.jpg) |
| *تصویر ۱: معرفی مسیر یادگیری و بازار کار Frontend* | *تصویر ۲: پرسش و پاسخ و تعامل با دانشجویان* |
